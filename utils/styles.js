// Lilac editor stylesheet, injected once per page.
//
// Lives in its own module so components/Editor.ts can call it without importing
// the package barrel (core/index.ts re-exports Editor, which would be a cycle).
// CSS injection helper - UI instructions for consistent styling
export function injectStyles() {
    if (document.getElementById('lilac-editor-styles'))
        return;
